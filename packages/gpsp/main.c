...
int main(int argc, char *argv[])
{
  ...
  //Start power button thread
  i = pthread_create( &ThreadPoll, NULL, PollThread, (void*)&cPower);
...
u32 update_gba()
{
  ...
  if(cPower)
  {
	...
	//System call to poweroff
	printf("Poweroff from update gba\n");
	popen("poweroff", "r");
	exit(0);		
	//Close gpsp
